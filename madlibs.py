...
# parts_speech_and_words is a user generated dictionary. key is 'part' and value is 'user input'.
...
# I didn't want to make one long paragraph using \n and \t to indent and tab. And I could figure out how to escape 'next line' indentation.
